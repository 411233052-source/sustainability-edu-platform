    ...
    <div className="space-y-6">
      <section className="rounded-2xl border border-emerald-200 bg-gradient-to-r from-emerald-50 to-teal-50 p-8 shadow-md">
        ...
        <p className="mt-4 max-w-3xl text-base leading-relaxed text-zinc-700 md:text-lg">
          本平台旨在建構從觀念至實務行動之永續學習路徑，並導入可視化進度追蹤以提升學習成效。隨著氣候變遷加劇與國際經貿法規趨嚴，「溫室氣體減量」已成為全球供應鏈之核心規範。然而，當前公眾對永續發展之認知多停留在概念層面。本教育平台之建置目的，即在於縮短「學術理論」與「業界實務」間之資訊落差。透過結構化之互動模組，引導學習者深入理解國際淨零趨勢，並建立企業轉型所需之實務專業職能。
        </p>
        <Link
          href={ctaHref}
